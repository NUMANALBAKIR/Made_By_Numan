...
namespace API.Migrations
{
    ...
    [Migration("20230328181623_implementedOnmodelcreating")]
    partial class implementedOnmodelcreating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Bank.Transaction", b =>
                {
                    ...
                    b.Property<decimal>("PreviousCheckingsBalance")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PreviousSavingsBalance")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("API.Models.StudentCRUD.Country", b =>
                {
            ...
            modelBuilder.Entity("API.Models.StudentCRUD.Student", b =>
                {
                    b.HasOne("API.Models.StudentCRUD.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Models.StudentCRUD.SubjectsList", "SubjectsList")
                        .WithMany()
